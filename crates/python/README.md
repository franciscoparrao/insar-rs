...
# End-to-end desde interferogramas ISCE (.unw desenrollados):
vel, series, epochs = insar_rs.sbas_from_isce(
    "merged/interferograms", baselines_dir="baselines")
# vel: (filas, cols) m/año ; series: (épocas, filas, cols) m ; epochs: ['YYYY-MM-DD', ...]
